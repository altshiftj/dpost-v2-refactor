...
class FileEventHandler(FileSystemEventHandler):
    ...
    def _schedule_debounce(self, path: str):
        ...
        # TODO: Reconsider this extension check? FileEventHandler should be universal
        # perhaps allow it and define permissible extensions in the settings
    ...
    def _add_item_to_queue(self, path: str):
        ...
        # TODO: Remove this extension check? FileEventHandler should be universal
        # perhaps allow it and define permissible extensions in the settings
