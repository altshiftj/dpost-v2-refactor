"""Device plugin wiring for the Eirich mixer R01."""
...
from ipat_watchdog.device_plugins.rmx_eirich_r01.file_processor import FileProcessorEirich
from ipat_watchdog.device_plugins.rmx_eirich_r01.settings import build_config
...
class EirichMixerR01Plugin(DevicePlugin):
    """Registers the Eirich R01 mixer with the Watchdog app."""
