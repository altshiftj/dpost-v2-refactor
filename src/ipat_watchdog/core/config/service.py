...
class ConfigService:
    ...
    def __init__(
        ...
        self._active_device: ContextVar[Optional[DeviceConfig]] = ContextVar(
...
class _DeviceActivation(AbstractContextManager[Optional[DeviceConfig]]):
    ...
    def __init__(
        self, service: ConfigService, device: DeviceConfig | str | None
    ) -> None:
    ...
    def _resolve_device(
        self, device: DeviceConfig | str | None
