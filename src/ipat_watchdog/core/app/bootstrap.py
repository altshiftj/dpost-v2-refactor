...
from ipat_watchdog.loader import get_devices_for_pc, load_device_plugin, load_pc_plugin
...
def bootstrap(
    ...
    *,
    ...
    sync_manager_factory: Callable[
        [UiInteractionAdapter], KadiSyncManager
    ] = KadiSyncManager,
) -> BootstrapContext:
    ...
    logger.info(
        "Starting Watchdog with PC=%s, devices=%s",
        resolved.pc_name,
