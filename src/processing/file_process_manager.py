...
class FileProcessManager:
    def __init__(self, ui: UserInterface, sync_manager: ISyncManager, session_manager: SessionManager, file_processor: BaseFileProcessor):
        self.ui = ui
    ...
    def _prompt_item_rename(self, src_path: str, filename_prefix: str, extension: str, bad_name_prompt: bool = True, new_record_prompt: bool = False):
        new_prefix = self._get_valid_rename(src_path, filename_prefix, extension, bad_name_prompt, new_record_prompt)
    ...
    def _get_valid_rename(self, src_path: str, filename_prefix: str, extension: str,
                      bad_name_prompt: bool, new_record_prompt: bool,
                      last_attempt: str = None) -> str | None:
        """
        ...
        while True:
            ...
            if bad_name_prompt:
                user_input = self.ui.show_unified_rename_dialog(attempted, last_analysis)
            else:
            ...
            if analysis["valid"]:
                ...
                last_analysis = analysis  # so next iteration highlights the correct errors
