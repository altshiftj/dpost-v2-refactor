"""DSV HORIBA device plugin registration under canonical dpost namespace."""
...
class DSVHoribaPlugin:
    """Register DSV HORIBA device with canonical dpost plugin loader."""
...
def register_device_plugins(registry: "DevicePluginRegistry") -> None:
    """Register canonical DSV HORIBA device plugin."""
