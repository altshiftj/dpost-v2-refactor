"""TISCHREM BLB PC plugin registration under canonical dpost namespace."""
...
from dpost.pc_plugins.tischrem_blb.settings import build_config
...
class PCTischREMPlugin:
    """Register TISCHREM BLB workstation with canonical dpost plugin loader."""
...
def register_pc_plugins(registry: "PCPluginRegistry") -> None:
    """Register canonical TISCHREM BLB PC plugin."""
