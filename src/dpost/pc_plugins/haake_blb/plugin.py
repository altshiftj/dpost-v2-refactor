"""HAAKE BLB PC plugin registration under canonical dpost namespace."""
...
class PCHaakePlugin:
    """Register HAAKE BLB workstation with canonical dpost plugin loader."""
...
def register_pc_plugins(registry: "PCPluginRegistry") -> None:
    """Register canonical HAAKE BLB PC plugin."""
