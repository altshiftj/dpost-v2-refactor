...
def test_initialize_new_db_record(sync_mgr, local_record):
    ...
    class DummyContext:
        def __init__(self):
            ...
            self.db_user = DummyKadiUser("abc-ipat")
            self.device_user = DummyKadiUser("device_user")
            self.device_record = DummyKadiRecord()
            self.device_record.id = "device_record_id"
            self.user_group = DummyKadiGroup("user_group")
            self.device_group = DummyKadiGroup("device_group")
    ...
    dummy_record.link_record.assert_called_with(context.device_record.id, "generated by")
