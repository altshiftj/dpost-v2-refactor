...
try:
    ...
    print("✓ build_config() returned DeviceConfig with id:", device_config.identifier)

    processor = FileProcessorSEMPhenomXL2(device_config)
    print("✓ FileProcessorSEMPhenomXL2 instantiated with DeviceConfig")
except Exception as e:
    print("✗ Config/Processor instantiation failed:", e)
    traceback.print_exc()
