...
if ($targetIP -eq "127.0.0.1") {
    ...
    powershell.exe -NoProfile -ExecutionPolicy Bypass -File "C:\\WatchdogDeploy\\register_task.ps1"
...
& $plinkPath -batch -pw "$targetPass" "${targetUser}@${targetIP}" "powershell -NoProfile -ExecutionPolicy Bypass -File C:\\WatchdogDeploy\\register_task.ps1"
