...
- Legacy gist: Keeps PC plugin `settings.py` ownership across mapped PC families. Template coverage extends to all mapped variants listed in `origin_v1_files`.
