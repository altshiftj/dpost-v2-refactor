...
| `_ProcessingPipeline` | Application (internal helper) | Sequence stage transitions for a single artifact | Resolve/stabilize/preprocess/route and persist-stage control flow | Direct record persistence implementation details |
