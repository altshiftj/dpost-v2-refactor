...
# FileProcessor handles file validation, renaming, and moving, interacts with the GUIManager to alert the user of naming issues
    ...
    def sync_files_to_database(self):
        ...
        for local_record in records_dict.values():
            ...
            if local_record.in_db and all(local_record.file_uploaded.values()):
                logger.info(f"Record '{local_record.record_name}' is up-to-date in the database.")
                continue
